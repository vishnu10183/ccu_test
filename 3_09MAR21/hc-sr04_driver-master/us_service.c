...
#define GPIO_ECHO 0 // GPIO 3 the echo pin
#define GPIO_TRIGGER 7 // GPIO 2 trigger pin
...
static ssize_t get_data(struct file *, char *, size_t, loff_t *); // helper function of reading the data by user space program
static ssize_t start_measuring(struct file *, const char *, size_t, loff_t *); // helper function for starting the measurement by user space program
...
//*******************************************************************
ssize_t start_measuring(struct file *filp, const char __user * buff, size_t count, loff_t * offset)
{
